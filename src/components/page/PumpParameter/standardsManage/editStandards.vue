<template>
  <div>
    <!-- 新增/修改模态框 -->
    <el-dialog :showClose='false' title="add" width="50%" :visible.sync="editVisible">
      <el-form class="addform" :model="userform" label-width="120px" size="small">
        ...
        <el-form-item class="addform-1" label="standarsExplain:">
        ...
        <el-form-item label="standarsPicture:">
          <el-upload class="avatar-uploader" :action="action" :show-file-list="false" :http-request="uploadImg" :on-success="handleAvatarSuccess">
