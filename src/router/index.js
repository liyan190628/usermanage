    ...
    routes: [{
        ...
        },
        {
            ...
            children: [{
                ...
                {
                    path: '/pumpParameter',
                    component: resolve => require(['@/components/page/PumpParameter/PumpParameterList/PumpParameterList.vue'], resolve),
                    meta: {
                        title: '泵参数管理'
                    }
                },
                {
                    path: '/pumpEdit',
                    name: 'pumpEdit',
                    component: resolve => require(['@/components/page/PumpParameter/PumpParameterList/pumpEdit.vue'], resolve),
                },
                {

                    path: '/motorManage',
                    component: resolve => require(['@/components/page/PumpParameter/motorManage/motorManage.vue'], resolve),
                    meta: {
                        title: 'MotorManage'
                    }
                },
                {
                    ...
                    component: resolve => require(['@/components/page/PumpParameter/standardsManage/standardsManage.vue'], resolve),
                    meta: {
                ...
                },
                {
                    ...
                    component: resolve => require(['@/components/page/PumpParameter/PumpParameterList/addPumpParameter.vue'], resolve),
                    meta: {
                        title: '新增泵参数'
                    }
                },
